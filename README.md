...
1. Build an application using the programming language of your choice in the `app/` folder which runs a webservice on Port 5000 and responds with "Hello Dialectic!" to any requests (e.g. curl http://localhost:5000/).
...
1. Send the zipped repo to your contact at Dialectic and wait for feedback.
